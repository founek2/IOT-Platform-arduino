...
void setup()
{
    ...
    Property *recieverPower = reciever->NewProperty("power", "Zapnutí", "boolean");
    ...
    Property *recieverVolume = reciever->NewProperty("volume", "Hlasitost", "integer");
    ...
    Property *recieverInput = reciever->NewProperty("input", "Vstup", "enum");
...
void syncYamaha()
{
    if (recieverPower->getValue() != yamaha.getPower())
        recieverPower->setValue(yamaha.getPower());
    if (recieverVolume->getValue() != yamaha.getVolume())
        recieverVolume->setValue(yamaha.getVolume());
    if (recieverInput->getValue() != yamaha.getInput())
        recieverInput->setValue(yamaha.getInput());
}
